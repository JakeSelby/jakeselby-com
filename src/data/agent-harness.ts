...
export const agentHarness = {
  ...
  role: 'Claude Code and Codex are the integration targets. The reference compatibility catalog lists qualified clients and capability gaps; Cursor and Grok integrations are planned.',
  brandColor: '#d97706',
