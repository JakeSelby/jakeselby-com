...
export const agentHarness = {
  ...
  role: 'v0.10.0 qualifies the Claude Code and Codex CLIs on macOS and Linux. VS Code and Codex Desktop remain unqualified, Cursor and Grok are planned, and the architecture viewer is a separately installed preview.',
  brandColor: '#d97706',
  statusLabel: 'Open source · v0.10.0',
  ...
  links: {
    ...
    repo: { href: 'https://github.com/JakeSelby/agent-harness/releases/tag/v0.10.0', label: 'v0.10.0 release' },
  },
};
